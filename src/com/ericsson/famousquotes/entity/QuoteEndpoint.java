package com.ericsson.famousquotes.entity;

import com.ericsson.famousquotes.entity.PMF;
...
@Api(name = "quoteendpoint", namespace = @ApiNamespace(ownerDomain = "ericsson.com", ownerName = "ericsson.com", packagePath = "famousquotes.entity"))
